    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider provider, RecipeOutput recipeOutput) {
        return new RecipeProvider(provider, recipeOutput) {
            ...
            public void buildRecipes() {
                ...
                //Polished Blackstone
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_BLACKSTONE.asItem(), Items.POLISHED_BLACKSTONE);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_BLACKSTONE_SLAB.asItem(), Items.POLISHED_BLACKSTONE, 2);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_BLACKSTONE_STAIRS.asItem(), Items.POLISHED_BLACKSTONE);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_BLACKSTONE.asItem(), Items.BLACKSTONE);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_BLACKSTONE_SLAB.asItem(), Items.BLACKSTONE, 2);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_BLACKSTONE_STAIRS.asItem(), Items.BLACKSTONE);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_BLACKSTONE_SLAB.asItem(), McddnBlocks.CUT_BLACKSTONE.asItem(), 2);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_BLACKSTONE_STAIRS.asItem(), McddnBlocks.CUT_BLACKSTONE.asItem());
                ...
                stairBuilder(McddnBlocks.CUT_BLACKSTONE_STAIRS.asItem(), Ingredient.of(McddnBlocks.CUT_BLACKSTONE.asItem()))
                        .unlockedBy(getHasName(McddnBlocks.CUT_BLACKSTONE.asItem()), has(McddnBlocks.CUT_BLACKSTONE.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.SPALLING_CUT_BLACKSTONE.asItem(), McddnBlocks.CUT_BLACKSTONE.asItem());
                ...
                shaped(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.INSET_POLISHED_BLACKSTONE.asItem(), 2)
                        ...
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.INSET_POLISHED_BLACKSTONE.asItem(), Items.BLACKSTONE);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.INSET_POLISHED_BLACKSTONE.asItem(), Items.POLISHED_BLACKSTONE);
                ...
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CHISELED_POLISHED_NETHERRACK.asItem(), McddnBlocks.POLISHED_NETHERRACK.asItem());
                shaped(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.INSET_POLISHED_NETHERRACK.asItem(), 2)
                        ...
                        .unlockedBy(getHasName(McddnBlocks.POLISHED_NETHERRACK.asItem()), has(McddnBlocks.POLISHED_NETHERRACK.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.INSET_POLISHED_NETHERRACK.asItem(), McddnBlocks.POLISHED_NETHERRACK.asItem());
                ...
                polishedBuilder(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_NETHERRACK.asItem(), Ingredient.of(McddnBlocks.POLISHED_NETHERRACK.asItem()))
                        .unlockedBy(getHasName(McddnBlocks.POLISHED_NETHERRACK.asItem()), has(McddnBlocks.POLISHED_NETHERRACK.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_NETHERRACK.asItem(), McddnBlocks.POLISHED_NETHERRACK.asItem());
                shapeless(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.MOLDY_CUT_NETHERRACK.asItem())
                        ...
                        .unlockedBy(getHasName(McddnBlocks.NETHER_WART_FLUFF.asItem()), has(McddnBlocks.NETHER_WART_FLUFF.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.SPALLING_CUT_NETHERRACK.asItem(), McddnBlocks.CUT_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_NETHERRACK_SLAB.asItem(), McddnBlocks.CUT_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_NETHERRACK_SLAB.asItem(), McddnBlocks.POLISHED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_NETHERRACK_STAIRS.asItem(), McddnBlocks.CUT_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_NETHERRACK_STAIRS.asItem(), McddnBlocks.POLISHED_NETHERRACK.asItem());
                ...
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CHISELED_POLISHED_RED_NETHERRACK.asItem(), McddnBlocks.POLISHED_RED_NETHERRACK.asItem());
                shaped(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.INSET_POLISHED_RED_NETHERRACK.asItem(), 2)
                        ...
                        .unlockedBy(getHasName(McddnBlocks.POLISHED_RED_NETHERRACK.asItem()), has(McddnBlocks.POLISHED_RED_NETHERRACK.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.INSET_POLISHED_RED_NETHERRACK.asItem(), McddnBlocks.POLISHED_RED_NETHERRACK.asItem());
                ...
                polishedBuilder(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_RED_NETHERRACK.asItem(), Ingredient.of(McddnBlocks.POLISHED_RED_NETHERRACK.asItem()))
                        .unlockedBy(getHasName(McddnBlocks.POLISHED_RED_NETHERRACK.asItem()), has(McddnBlocks.POLISHED_RED_NETHERRACK.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_RED_NETHERRACK.asItem(), McddnBlocks.POLISHED_RED_NETHERRACK.asItem());
                shapeless(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.MOLDY_CUT_RED_NETHERRACK.asItem())
                        ...
                        .unlockedBy(getHasName(McddnBlocks.NETHER_WART_FLUFF.asItem()), has(McddnBlocks.NETHER_WART_FLUFF.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.SPALLING_CUT_RED_NETHERRACK.asItem(), McddnBlocks.CUT_RED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_RED_NETHERRACK_SLAB.asItem(), McddnBlocks.CUT_RED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_RED_NETHERRACK_SLAB.asItem(), McddnBlocks.POLISHED_RED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_RED_NETHERRACK_STAIRS.asItem(), McddnBlocks.CUT_RED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, McddnBlocks.CUT_RED_NETHERRACK_STAIRS.asItem(), McddnBlocks.POLISHED_RED_NETHERRACK.asItem());
