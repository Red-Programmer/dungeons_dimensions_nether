    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider provider, RecipeOutput recipeOutput) {
        return new RecipeProvider(provider, recipeOutput) {
            ...
            public void buildRecipes() {
                ...
                //shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_BLACKSTONE.asItem(), 4).pattern("##").pattern("##").define('#', Items.POLISHED_BLACKSTONE).unlockedBy(getHasName(Items.POLISHED_BLACKSTONE), has(Items.POLISHED_BLACKSTONE));

                //Polished Blackstone
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_BLACKSTONE.asItem(), Items.POLISHED_BLACKSTONE);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_BLACKSTONE_SLAB.asItem(), Items.POLISHED_BLACKSTONE, 2);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_BLACKSTONE_STAIRS.asItem(), Items.POLISHED_BLACKSTONE);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_BLACKSTONE.asItem(), Items.BLACKSTONE);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_BLACKSTONE_SLAB.asItem(), Items.BLACKSTONE, 2);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_BLACKSTONE_STAIRS.asItem(), Items.BLACKSTONE);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_BLACKSTONE_SLAB.asItem(), ModBlocks.CUT_BLACKSTONE.asItem(), 2);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_BLACKSTONE_STAIRS.asItem(), ModBlocks.CUT_BLACKSTONE.asItem());
                ...
                stairBuilder(ModBlocks.CUT_BLACKSTONE_STAIRS.asItem(), Ingredient.of(ModBlocks.CUT_BLACKSTONE.asItem()))
                        .unlockedBy(getHasName(ModBlocks.CUT_BLACKSTONE.asItem()), has(ModBlocks.CUT_BLACKSTONE.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SPALLING_CUT_BLACKSTONE.asItem(), ModBlocks.CUT_BLACKSTONE.asItem());
                ...
                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.INSET_POLISHED_BLACKSTONE.asItem(), 2)
                        ...
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.INSET_POLISHED_BLACKSTONE.asItem(), Items.BLACKSTONE);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.INSET_POLISHED_BLACKSTONE.asItem(), Items.POLISHED_BLACKSTONE);
                ...
                chiseledBuilder(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_POLISHED_NETHERRACK.asItem(), Ingredient.of(ModBlocks.POLISHED_NETHERRACK_SLAB))
                        ...
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_NETHERRACK_SLAB.asItem(), ModBlocks.POLISHED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_POLISHED_NETHERRACK.asItem(), ModBlocks.POLISHED_NETHERRACK.asItem());
                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.INSET_POLISHED_NETHERRACK.asItem(), 2)
                        ...
                        .unlockedBy(getHasName(ModBlocks.POLISHED_NETHERRACK.asItem()), has(ModBlocks.POLISHED_NETHERRACK.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.INSET_POLISHED_NETHERRACK.asItem(), ModBlocks.POLISHED_NETHERRACK.asItem());
                ...
                polishedBuilder(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_NETHERRACK.asItem(), Ingredient.of(ModBlocks.POLISHED_NETHERRACK.asItem()))
                        .unlockedBy(getHasName(ModBlocks.POLISHED_NETHERRACK.asItem()), has(ModBlocks.POLISHED_NETHERRACK.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_NETHERRACK.asItem(), ModBlocks.POLISHED_NETHERRACK.asItem());
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOLDY_CUT_NETHERRACK.asItem())
                        .requires(ModBlocks.CUT_NETHERRACK.asItem())
                        .requires(ModBlocks.NETHER_WART_FLUFF.asItem())
                        .unlockedBy(getHasName(ModBlocks.NETHER_WART_FLUFF.asItem()), has(ModBlocks.NETHER_WART_FLUFF.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SPALLING_CUT_NETHERRACK.asItem(), ModBlocks.CUT_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_NETHERRACK_SLAB.asItem(), ModBlocks.CUT_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_NETHERRACK_SLAB.asItem(), ModBlocks.POLISHED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_NETHERRACK_STAIRS.asItem(), ModBlocks.CUT_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_NETHERRACK_STAIRS.asItem(), ModBlocks.POLISHED_NETHERRACK.asItem());
                ...
                chiseledBuilder(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_POLISHED_RED_NETHERRACK.asItem(), Ingredient.of(ModBlocks.POLISHED_RED_NETHERRACK_SLAB))
                        ...
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_RED_NETHERRACK_SLAB.asItem(), ModBlocks.POLISHED_RED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CHISELED_POLISHED_RED_NETHERRACK.asItem(), ModBlocks.POLISHED_RED_NETHERRACK.asItem());
                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.INSET_POLISHED_RED_NETHERRACK.asItem(), 2)
                        ...
                        .unlockedBy(getHasName(ModBlocks.POLISHED_RED_NETHERRACK.asItem()), has(ModBlocks.POLISHED_RED_NETHERRACK.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.INSET_POLISHED_RED_NETHERRACK.asItem(), ModBlocks.POLISHED_RED_NETHERRACK.asItem());
                ...
                polishedBuilder(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_RED_NETHERRACK.asItem(), Ingredient.of(ModBlocks.POLISHED_RED_NETHERRACK.asItem()))
                        .unlockedBy(getHasName(ModBlocks.POLISHED_RED_NETHERRACK.asItem()), has(ModBlocks.POLISHED_RED_NETHERRACK.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_RED_NETHERRACK.asItem(), ModBlocks.POLISHED_RED_NETHERRACK.asItem());
                shapeless(RecipeCategory.BUILDING_BLOCKS, ModBlocks.MOLDY_CUT_RED_NETHERRACK.asItem())
                        ...
                        .unlockedBy(getHasName(ModBlocks.NETHER_WART_FLUFF.asItem()), has(ModBlocks.NETHER_WART_FLUFF.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SPALLING_CUT_RED_NETHERRACK.asItem(), ModBlocks.CUT_RED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_RED_NETHERRACK_SLAB.asItem(), ModBlocks.CUT_RED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_RED_NETHERRACK_SLAB.asItem(), ModBlocks.POLISHED_RED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_RED_NETHERRACK_STAIRS.asItem(), ModBlocks.CUT_RED_NETHERRACK.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.CUT_RED_NETHERRACK_STAIRS.asItem(), ModBlocks.POLISHED_RED_NETHERRACK.asItem());
                ...
                slabBuilder(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_DARK_NETHERRACK_SLAB.asItem(), Ingredient.of(ModBlocks.POLISHED_DARK_NETHERRACK.asItem()))
                        ...
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.POLISHED_DARK_NETHERRACK_SLAB.asItem(), ModBlocks.POLISHED_DARK_NETHERRACK.asItem());
                ...
                shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DARK_NETHER_BRICKS.asItem(), 8)
                        ...
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.SPALLING_NETHER_BRICKS.asItem(), Items.NETHER_BRICKS);
                ...
                wallBuilder(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DARK_NETHER_BRICK_WALL.asItem(), Ingredient.of(ModBlocks.DARK_NETHER_BRICKS.asItem()))
                        .unlockedBy(getHasName(ModBlocks.DARK_NETHER_BRICKS.asItem()), has(ModBlocks.DARK_NETHER_BRICKS.asItem()))
                        .save(output);
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DARK_NETHER_BRICK_SLAB.asItem(), ModBlocks.DARK_NETHER_BRICKS.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DARK_NETHER_BRICK_STAIRS.asItem(), ModBlocks.DARK_NETHER_BRICKS.asItem());
                stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, ModBlocks.DARK_NETHER_BRICK_WALL.asItem(), ModBlocks.DARK_NETHER_BRICKS.asItem());
