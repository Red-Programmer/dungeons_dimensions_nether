...
public class FortressCapFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> featurePlaceContext) {
        ...
        drawLine(level, corner.above(12).offset(direction.getOpposite().getNormal()), McddnBlocks.INSET_POLISHED_NETHERRACK.defaultBlockState(), direction.getClockWise(), 9);
        ...
        drawLine(level, corner.offset(direction.getClockWise().getNormal().multiply(2)), McddnBlocks.INSET_POLISHED_NETHERRACK.defaultBlockState(), direction.getClockWise(), 5);
        corner = corner.offset(direction.getOpposite().getNormal());
        if (level.getBlockState(corner.offset(direction.getClockWise().getNormal().multiply(4))).is(McddnTags.Blocks.BLACKSTONE_TILES)) {
            drawLine(level, corner.offset(direction.getClockWise().getNormal().multiply(3)), McddnBlocks.INSET_POLISHED_BLACKSTONE.defaultBlockState(), direction.getClockWise(), 3);
        }
        ...
        this.setBlock(level, blockPos.above(3).offset(direction.getCounterClockWise().getNormal().multiply(2)), McddnBlocks.CHISELED_POLISHED_NETHERRACK.defaultBlockState());
        this.setBlock(level, blockPos.above(3).offset(direction.getClockWise().getNormal().multiply(2)), McddnBlocks.CHISELED_POLISHED_NETHERRACK.defaultBlockState());
